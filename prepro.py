...
def main():
    ...
    caption_file = './data/clevr_train_annotations.json'
    image_dir = 'image/%2014_resized/'

    # about 80000 images and 400000 captions for train dataset
    train_dataset = _process_caption_data(caption_file='./data/clevr_train_annotations.json',
                                          image_dir='image/train2014_resized/',
                                          max_length=max_length)

    # about 40000 images and 200000 captions
    val_dataset = _process_caption_data(caption_file='./data/clevr_val_annotations.json',
